...
## 🚀 What's New in v0.2.0: Transcripts

Now you can keep a log of what you delete!

* **Transcription System:** Added a new toggle button in the UI (turns green when active). When deletion starts, a background tab (`transcript.html`) opens to log in real-time:
    * Message timestamp.
    * Username.
    * Message content.

    **UI/UX Improvements**
- Renamed "Errors" label to **"Console"** for technical clarity.
- Removed auto-detection for full server wipe (manual ID entry now required).
- Added user alerts when enabling Transcript mode.
